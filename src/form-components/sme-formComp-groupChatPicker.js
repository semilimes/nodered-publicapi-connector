...
module.exports = function(RED) {
    function FormCompGroupChatPickerNode(config) {
        ...
        node.on('input', function(msg, send, done) {
            ...
            if(smeFormMsg && smeFormMsg.dataComponent && smeFormMsg.dataComponent.formComponents) {
                smeFormMsg.dataComponent.formComponents.push({
                    ...
                    formComponentType: "groupChatPicker",
                    title: titleValue,
                    requiredSelection: false,
                    value: [],
                    actionButtonTitle: actionButtonTitleValue || "Select Group Chat",
    ...
    RED.nodes.registerType("sme-formComp-groupChatPicker", FormCompGroupChatPickerNode);
}