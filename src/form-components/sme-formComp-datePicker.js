...
module.exports = function(RED) {
    function FormCompDatePickerNode(config) {
        ...
        node.on('input', function(msg, send, done) {
            ...
            if(smeFormMsg && smeFormMsg.dataComponent && smeFormMsg.dataComponent.formComponents) {
                smeFormMsg.dataComponent.formComponents.push({
                    ...
                    value: "",
                    actionButtonTitle: actionButtonTitleValue || "Select Date"
                });
            }
    ...
    RED.nodes.registerType("sme-formComp-datePicker", FormCompDatePickerNode);
}