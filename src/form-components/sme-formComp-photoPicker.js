...
module.exports = function(RED) {
    function FormCompPhotoPickerNode(config) {
        ...
        node.on('input', function(msg, send, done) {
            ...
            if(smeFormMsg && smeFormMsg.dataComponent && smeFormMsg.dataComponent.formComponents) {
                smeFormMsg.dataComponent.formComponents.push({
                    ...
                    value: [],
                    actionButtonTitle: actionButtonTitleValue || "Select Photos",
    ...
    RED.nodes.registerType("sme-formComp-photoPicker", FormCompPhotoPickerNode);
}