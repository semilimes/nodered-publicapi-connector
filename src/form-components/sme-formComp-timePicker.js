...
module.exports = function(RED) {
    function FormCompTimePickerNode(config) {
        ...
        node.on('input', function(msg, send, done) {
            ...
            if(smeFormMsg && smeFormMsg.dataComponent && smeFormMsg.dataComponent.formComponents) {
                smeFormMsg.dataComponent.formComponents.push({
                    ...
                    value: "",
                    actionButtonTitle: actionButtonTitleValue || "Select Time"
                });
            }
    ...
    RED.nodes.registerType("sme-formComp-timePicker", FormCompTimePickerNode);
}