...
module.exports = function(RED) {
    function FormCompFilePickerNode(config) {
        ...
        node.on('input', function(msg, send, done) {
            ...
            if(smeFormMsg && smeFormMsg.dataComponent && smeFormMsg.dataComponent.formComponents) {
                smeFormMsg.dataComponent.formComponents.push({
                    ...
                    value: [],
                    actionButtonTitle: actionButtonTitleValue || "Select Files",
    ...
    RED.nodes.registerType("sme-formComp-filePicker", FormCompFilePickerNode);
}