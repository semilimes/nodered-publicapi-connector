...
module.exports = function(RED) {
    function FormCompChannelPickerNode(config) {
        ...
        node.on('input', function(msg, send, done) {
            ...
            if(smeFormMsg && smeFormMsg.dataComponent && smeFormMsg.dataComponent.formComponents) {
                smeFormMsg.dataComponent.formComponents.push({
                    ...
                    formComponentType: "channelPicker",
                    title: titleValue,
                    requiredSelection: false,
                    value: [],
                    actionButtonTitle: actionButtonTitleValue || "Select Channel",
    ...
    RED.nodes.registerType("sme-formComp-channelPicker", FormCompChannelPickerNode);
}